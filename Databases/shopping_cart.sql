...
', '1 TB Hard Disk', '450W', 'Intel', 'Intel HD Graphics 520', 'Intel Core i3 (6th Gen)', 10, 1);
go
INSERT INTO product(name, quantity, imageurl, description, chip, ram, monitor, harddrive, power, mainboard, vga, cpu, price, brandid) 
...
', '1 TB Hard Disk', '450W', 'Intel', 'Intel HD Graphics 5500', 'Intel Core i3 (5th Gen)', 20, 1);
go
INSERT INTO product(name, quantity, imageurl, description, chip, ram, monitor, harddrive, power, mainboard, vga, cpu, price, brandid) 
...
', '500GB Hard Disk', '450W', 'Intel', 'Intel HD Graphics 5500', 'Intel Celeron Dual Core', 30, 1);
go
INSERT INTO product(name, quantity, imageurl, description, chip, ram, monitor, harddrive, power, mainboard, vga, cpu, price, brandid) 
...
', '500GB Hard Disk', '450W', 'Intel', 'Intel HD Graphics', 'Intel Celeron Dual Core (4th Gen)', 40, 1);
go
INSERT INTO product(name, quantity, imageurl, description, chip, ram, monitor, harddrive, power, mainboard, vga, cpu, price, brandid) 
...
', '1 TB Hard Disk', '450W', 'Intel', '4 GB NVIDIA Graphics Card', 'Intel Core i5', 50, 1);
